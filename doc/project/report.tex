...
\begin{mycompactdesc}
    ...
    \item[enum] Tests simple enumerations
...
\end{mycompactdesc}
The source code and results of all tests have been documented in \texttt{testreport.pdf}.
...
What went well in the project is tokenizing, parsing and AST-building of the expressions. I definitely consider programming the first and second phase of compilers as one my stronger skills. Something I could work on is improving the programming of the code-generation phase.
